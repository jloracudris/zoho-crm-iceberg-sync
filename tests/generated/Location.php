...
class Location implements \Wabel\Zoho\CRM\ZohoBeanInterface {
	...
	/**
	 * Zoho field CustomModule17 Name
	 * Type: Text
	 * Read only: false
	 * Max length: 120
	 * Custom field: false
	 ...
	 * @var string
	 */
	protected $customModule17Name;

	/**
	 * Zoho field CustomModule17 Owner
	 * Type: Lookup
	 * Read only: false
	 * Max length: 120
	 * Custom field: false
	...
	/**
	 * Whether 'customModule17Name' has been changed or not.
	 *
	 * @var bool
	 */
	protected $dirtyCustomModule17Name = false;

	/**
	 * Whether 'customModule17Owner' has been changed or not.
	 *
	 * @var bool
	 */
	protected $dirtyCustomModule17Owner = false;
	...
	/**
	 * Get zoho field CustomModule17 Name
	 * Type: Text
	 * Read only: false
	 * Max length: 120
	 * Custom field: false
	 */
	public function getCustomModule17Name() {
		return $this->customModule17Name;
	}

	/**
	 * Get zoho field CustomModule17 Owner
	 * Type: Lookup
	 * Read only: false
	 * Max length: 120
	 * Custom field: false
	 */
	public function getCustomModule17Owner() {
		return $this->customModule17Owner;
	}
	...
	/**
	 * Set zoho field CustomModule17 Name
	 * Type: Text
	 * Read only: false
	 * Max length: 120
	 * Custom field: false
	 *
	 * @param string $customModule17Name
	 */
	public function setCustomModule17Name($customModule17Name) {
		$this->customModule17Name = $customModule17Name;
		$this->dirtyCustomModule17Name = true;
		return $this;
	}

	/**
	 * Set zoho field CustomModule17 Owner
	 * Type: Lookup
	 * Read only: false
	 * Max length: 120
	 * Custom field: false
	 *
	 * @param string $customModule17Owner
	 */
	public function setCustomModule17Owner($customModule17Owner) {
		$this->customModule17Owner = $customModule17Owner;
		$this->dirtyCustomModule17Owner = true;
		return $this;
	}
